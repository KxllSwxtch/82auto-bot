...
Чем быстрее вы определитесь с автомобилем и выберите нужный вариант
Наличие авто на площадках, которые бы соответствовали вашим требования
Ожидание и реальность не соответствуют Мы часто сталкиваемся с тем, что в объявлении указана не достоверная информация об авто. Продавец не всегда знает настоящее состояние автомобиля
""",
        },
        {
...
""",
        ...
        {"question": "Когда я получу ЭПТС?", "answer": "В лабораториях бывают очереди, поэтому срок получения ЭПТС составляет до 7 дней"},
        { "question": "Какое время в пути по морю?", 'answer': "Если авто выходит с порта ДОНГХЕ, то время в пути 1 сутки\nЕсли авто выходит с порта ПУСАН, то время в пути 2 суток" }
