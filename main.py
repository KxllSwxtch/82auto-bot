...
ПТД (пассажирская таможенная декларация)
    ...
    "Логистика": [
        {
            "question": "Авто могут повредить при доставке до Владивостока?",
        ...
        {
            "question": "Доставите авто из Владивостока в мой город?",
    ...
    "Сроки": [
        {
            "question": "Сколько дней до авто во Владике с доками?",
        ...
        {
            "question": "Сколько авто плывёт до Владивостока?",
    ...
    "Прочее": [
        {
            "question": "Делаете фото/видео авто в Корее и при отправке?",
            "answer": """
