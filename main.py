...
1.200 USDT""",
        ...
        {
            "question": "Внесенный депозит (100.000 рублей) – это стоимость услуг компании или эта сумма будет вычтена из стоимости авто?",
...
После просмотра видео и фотоотчета Вам необходимо дать ответ: бронируем мы авто или нет
        ...
        {
            "question": "Сколько осмотров входит в стоимость ваших услуг?",
    ...
    "Документы": [
        ...
        {
            "question": "Какие документы у меня будут на руках, когда я получу свой автомобиль?",
            "answer": """
...
ПТД (пассажирская таможенная декларация)
    ...
    "Логистика": [
        {
            "question": "Мой автомобиль может быть поврежден во время перевозки во Владивосток?",
            "answer": "В теории может. Но мы работаем только с проверенными транспортными компаниями, чтобы свести подобные риски к минимуму. Напоминаем также, что автомобиль застрахован на все время перевозки от стоянки диллера до получения Вами во Владивостоке",
        },
        {
            "question": "Сможете ли вы доставить автомобиль из Владивостока в мой город?",
        ...
        {
            "question": "Сможете ли вы перегнать мой автомобиль из таможни на автовоз? ",
            "answer": "Да во Владивостоке у нас есть сотрудник, который перегонит ваш авто. Стоимость услуг уже включена в общую цену",
        },
    ],
    "Сроки": [
        {
            "question": "Сколько по времени занимает процесс от обращения к вам и до получения авто во Владивостоке со всеми документами?",
            "answer": "С момента покупки авто в Корее, до момента доставки в порт Владивосток срок составит до 2-х недель + таможенное оформление до 10 дней. (Возможно увеличение сроков из за погодных условий и других случаев, не зависящих от нас)",
        },
        {
            "question": "Сколько по времени автомобиль идет по морю в порт Владивосток?",
            "answer": "Если авто выходит с порта ДОНГХЕ, то время в пути 1 сутки\nЕсли авто выходит с порта ПУСАН, то время в пути 2 суток",
        },
        {
            "question": "Сколько по времени занимает растаможка автомобиля? ",
            "answer": "От 7 до 14 дней",
        },
    ],
    "Прочее": [
        {
            "question": "Осуществляете ли Вы  фото и видеосъемку автомобиля (со стоянки в Корее/в порту отправки/на автовозе)?",
            "answer": """
Фото и видеосъемка осуществляется во время осмотра авто. 
После выкупа автомобиля у диллера, ваш автомобиль пригоняют к нам на стоянку. На стоянке наши сотрудники делают фотоопись
При погрузке на автовоз
В порту отплытия
При выпуске авто с СВХ во Владивостоке
""",
        }
    ],
}
